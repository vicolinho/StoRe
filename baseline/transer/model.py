...
def predict_from_pickle(src_dataset, src_link, tgt_dataset, tgt_link, k=7, t_c=0.9,
            t_l=0.9, t_p=0.99):
    result_list = list()
    ...
    for i in range(3):
        ...
        src_dataset_file = os.path.join(os.getcwd(), 'data/{}/sampled-{}-{}.pkl'.format(src_dataset,
                                                                                               src_link, i))
        ...
        tgt_dataset_file = os.path.join(os.getcwd(), 'data/{}/sampled-{}-{}.pkl'.format(tgt_dataset,
                                                              tgt_link, i))
...
def predict(src_feature_dict, tgt_feature_dict, k=7, t_c=0.9,
            t_l=0.9, t_p=0.99):
    result_list = list()
