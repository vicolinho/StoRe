...
def precision(confusion_matrix):
  ...
  """
    ...
    num_tp = confusion_matrix[0]
    num_fp = confusion_matrix[1]
    precision = float(num_tp) / float(num_tp + num_fp)
    return precision
...
def recall(confusion_matrix):
  ...
  """
    ...
    num_tp = confusion_matrix[0]
    num_fn = confusion_matrix[2]
    recall = float(num_tp)/float(num_tp + num_fn)  # Replace with your code
    return recall
...
def pairs_completeness(cand_rec_id_pair_list, true_match_set):
  ...
  """
    ...
    cand_set = set(cand_rec_id_pair_list)
    intersect = cand_set.intersection(true_match_set)

    pc = float(len(intersect))/len(true_match_set)  # Replace with your code
...
def pairs_quality(cand_rec_id_pair_list, true_match_set):
  ...
  """
    ...
    cand_set = set(cand_rec_id_pair_list)
    intersect = cand_set.intersection(true_match_set)
    pq = float(len(intersect))/len(cand_rec_id_pair_list)  # Replace with your code
